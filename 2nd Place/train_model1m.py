...
data_df = data_df.sample(frac=1, random_state=42+2).reset_index(drop=True)

skf = KFold(n_splits=CFG.n_fold, shuffle=True, random_state=42)
...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        assert sampling_rate == sampling_rate2
...
class CustomModel(nn.Module):
    def __init__(self):
        ...
        #self.fc2 = nn.Linear(self.text_model.config.hidden_size, 512)
