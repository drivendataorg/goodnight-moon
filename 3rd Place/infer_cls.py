...
def main():
    ...
    # Using two folds for transcription due to time constraints,
    # possibly using prediction from 5 folds may improve the result
    dfs = []
    ...
    # Just repeat transcriptions from two folds interchangeably
